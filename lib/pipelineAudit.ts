...
export function sourceInventory(): SourceInventoryItem[] {
  ...
  return [
    ...
    },
    {
      ...
      enabled: true,
      type: "real_api",
      usedBy: ["lib/signals/sources/editorialSignals.ts#fetchFeedArticles"],
      contribution: { ...sharedFalse, ranking: true, scoring: true, aboutToHit: true },
      notes: "Lightweight RSS ingestion feeding editorial convergence signals.",
    },
    {
      ...
      usedBy: ["lib/signals/sources/editorialSignals.ts#fetchFeedArticles"],
      contribution: { ...sharedFalse, ranking: true, scoring: true, aboutToHit: true },
      notes: "Lightweight feed ingestion feeding editorial convergence signals.",
    },
    {
