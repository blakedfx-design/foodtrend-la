...
const FALLBACK_ABOUT_ROWS: Omit<AboutToHitTrend, "rank">[] = [
  ...
  {
    trend_name: "Filipino BBQ Nights",
    emerging_dish_or_item: "Calamansi-and-vinegar skewers over charcoal with smoky late-night energy.",
    early_places_to_watch: ["Filipino street-skewer grills", "Late-night neighborhood patios"],
    why_it_could_pop: "Skewer-first dining turns dinner into a social activity with smoke-driven flavor.",
    watch_signal: "More LA menus featuring Filipino charcoal skewers as dedicated late-night draws.",
    trend_score: 55,
    trend_stage: "Emerging",
    sources: [DEFAULT_SOURCE],
  },
